...
class PythonLanguage {
    ...
    async detect() {
        ...
        return (files.length > 0 || pyprojectFiles.length > 0 || setupFiles.length > 0);
    }
    ...
    updateRequirementsTxt(strategy) {
    ...
    updateSetupPy() {
        ...
        this.logger.warning("⚠️  setup.py detected but automated updates are limited");
