...
exports.NodeJSLanguage = void 0;
class NodeJSLanguage {
    ...
    async audit() {
        try {
            if (!this.shell.commandExists("npm") ||
            ...
            if (vulnerabilities.critical > 0) {
                this.logger.error(`⛔ CRITICAL vulnerabilities: ${vulnerabilities.critical}`);
                return false;
            }
            if (vulnerabilities.high > 0) {
                this.logger.warning(`⚠️  HIGH vulnerabilities: ${vulnerabilities.high}`);
            }
...
exports.NodeJSLanguage = NodeJSLanguage;
