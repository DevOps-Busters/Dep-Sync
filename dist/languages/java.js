...
class JavaLanguage {
    ...
    async update(strategy) {
        try {
            ...
            if (this.shell.exists("build.gradle") ||
    ...
    updateMaven() {
        ...
        this.shell.execSync("mvn versions:use-latest-versions -DgenerateBackupPoms=false");
    ...
    updateGradleWrapper() {
        ...
        if (tasks.includes("dependencyUpdates")) {
            ...
            this.logger.info("   Add: id 'com.github.ben-manes.versions' to build.gradle");
        }
        this.logger.success("Gradle dependencies checked");
        return true;
    }
